...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <table class="nav-justified">
            <tr>
                <td>     
                    <a href="About.aspx"><img src="Images/resumeLogo.jpg" height= "150" width="150" /></a>  <br />My Resume </td>
                <td> 
                    <a href="Contact.aspx"><img src="Images/Contact.png" height= "150" width="150" /></a><br />  My Contact Info</td>
            </tr>
        </table>       
